...
export const UPBIT_GUIDE = {
  ...
  note: "어떤 리소스를 어떻게 활용했는지 최종 발표에 명시해 주세요.",
} as const;
...
export const TRACK_CHECKPOINTS = [
  {
    ...
    body: "좋은 아이디어가 실제 서비스가 되기 위해서는 개인정보, 보안, 관련 법령, 이용약관, 사용자 보호 등 다양한 현실적 조건을 통과해야 합니다. 팀의 아이디어가 세상에 안착하려면 어떤 설계가 필요한지도 함께 고민해 주세요.",
  },
  {
    title: "서비스화 최소 체크포인트",
