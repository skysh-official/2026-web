...
const FAQS = [
  ...
  {
    q: "팀으로 참가할 수 있나요?",
    a: "개인 참가와 팀 참가 모두 가능합니다. 개인 참가자는 신청서에 희망 개발 분야와 경험을 작성하면, 운영진이 이를 참고해 함께 개발할 팀을 배정합니다. 팀 참가자는 2-4명으로 신청할 수 있습니다.",
  },
  {
    q: "어떤 혜택이 있나요?",
    a: "우수 12팀은 본선에 진출하며, AWS 현업 전문가 멘토링과 개발 환경, 식사, 간식을 지원받습니다.",
  },
  {
    q: "시상은 어떻게 되나요?",
